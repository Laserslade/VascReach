...
if __name__ == "__main__":
    csv_path = os.path.join(os.path.dirname(__file__), "..", "..", "results", "actuator_selection", "shortlist_diagnostic.csv")
    out_dir = os.path.join(os.path.dirname(__file__), "..", "..", "figures", "actuator_selection")
