...
if __name__ == "__main__":
    ...
    batches_path = os.path.join(base, "..", "..", "results", "calibration", "calibration_batches.csv")
    rows = load_batches(batches_path)

    delta_rows = compute_delta_p(rows)
    with open(os.path.join(base, "..", "..", "results", "calibration", "calibration_delta_p.csv"), "w", newline="") as f:
    ...
    with open(os.path.join(base, "..", "..", "results", "calibration", "calibration_delta_num.csv"), "w", newline="") as f:
